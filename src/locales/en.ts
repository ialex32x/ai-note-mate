export const en: Record<string, string> = {
	...
	'settings.deleteAgentDesc': 'Remove this agent from the list. The note itself is not deleted.',
	'settings.agentsEmpty': 'No custom agents',
	'settings.agentsEmptyDesc': 'Add an agent, then point it at a note. The note\'s frontmatter `tools` field lists allowed tool patterns and its body becomes the agent\'s prompt.',
	'settings.agentUntitled': 'Untitled agent',
	'settings.agentNotePath': 'Agent note path',
	'settings.agentNotePathDesc': 'Vault-relative path of the note that defines this agent. Edit the note directly to configure the agent; this panel only shows a read-only preview.',
	'settings.agentNotePathPlaceholder': 'e.g. Agents/My agent.md',
	'settings.agentNotePathEmptyError': 'Agent note path is empty.',
	'settings.agentOpenNote': 'Open the agent note in a new tab',
	'settings.agentNoteMissing': 'Agent note does not exist yet.',
	'settings.agentCreateDefault': 'Create the agent note from the default template',
	'settings.agentCreated': 'Agent note created at {path}.',
	'settings.agentParsedConfig': 'Parsed configuration',
	'settings.agentTools': 'Tools',
	'settings.agentToolsNone': 'No tool patterns defined (frontmatter `tools` is empty).',
	'settings.agentPrompt': 'Prompt',
	'settings.agentPromptEmpty': 'No prompt content (note body is empty).',
	'settings.agentPathEmpty': 'Set a note path above to load this agent\'s configuration.',
	'settings.agentLoading': 'Loading agent configuration…',
	'settings.agentReadFailed': 'Failed to read agent note: {msg}',
