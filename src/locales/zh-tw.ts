export const zhTW: Record<string, string> = {
	...
	'view.cannotSwitchWhileStreaming': 'AI 回覆中，無法切換對話。',
	...
	'view.mcpTools': 'MCP',
	'view.mcpNoServers': '暫無已連接的 MCP 伺服器',
	'view.mcpExpandTools': '展開/摺疊工具列表',
	'view.profiles': '文本生成',
	'view.imageGen': '圖片生成',
	...
	'statusTooltip.embeddingUnused': '嵌入：當前會話尚未使用',
	'statusTooltip.embeddingUnavailable': '嵌入：不可用，已回退至全量工具集',
	'statusTooltip.embeddingOk': '嵌入：運行正常',
