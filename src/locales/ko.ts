export const ko: Record<string, string> = {
	...
	'settings.agentToolsPreview': 'MCP 도구 미리보기',
	'settings.agentToolsPreviewNone': '도구 패턴이 정의되지 않았습니다. 위에 패턴을 추가하면 일치하는 MCP 도구가 여기에 표시됩니다.',
	'settings.agentToolsPreviewNoMcp': 'MCP 서버 도구가 구성되지 않았습니다. 먼저 설정 → Tools에서 서버를 설정하세요.',
	'settings.agentToolsPreviewNoMatch': '설정된 패턴과 일치하는 MCP 도구가 없습니다.',
	'settings.agentToolsPreviewCount': '{count}개의 MCP 도구 일치',
