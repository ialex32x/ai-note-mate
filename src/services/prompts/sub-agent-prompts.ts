...
3. **Line-level edits** (e.g. "drop lines 40-50", "rewrite lines 20-25"): use \`edit_lines\` with its \`edits\` array for replace/delete. For inserts (e.g. "insert a paragraph before line 12"), use \`insert_lines_before\`. Set \`strategy: "lines"\`.
