export const en: Record<string, string> = {
	...
	'settings.memoryRelevantTopKDesc': 'Maximum number of non-critical entries selected per turn by embedding similarity. Set to 0 to disable the relevant pool.',
	'settings.memoryRelevantMinSimilarity': 'Relevant memory: similarity threshold',
	'settings.memoryRelevantMinSimilarityDesc': 'Minimum cosine similarity (0–1) for a non-critical entry to be kept after embedding-based filtering. Tune to match your embedding model\'s score distribution.',
