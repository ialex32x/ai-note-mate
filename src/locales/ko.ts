...
`,
	...
	'tips.configureProfile.title': 'AI 프로필 설정',
	'tips.configureProfile.body': '대화를 시작하기 전에 활성 프로필에서 Base URL, 모델, API 키를 입력하세요. API 키는 Obsidian Keychain에 저장되며 플러그인 설정에 평문으로 기록되지 않으므로 안심하고 사용할 수 있습니다. 「해보기」를 누르면 프로필 섹션으로 바로 이동합니다.',
	'tips.configureProfile.openFailed': '설정 패널을 자동으로 열 수 없습니다. 설정 → Note Mate → 프로필 을 직접 열어 주세요.',
