...
describe('ContextCompressor.collapseToolMessagesForSummary', () => {
    it('should return empty array for empty input', () => {
        expect(ContextCompressor.collapseToolMessagesForSummary([])).toEqual([]);
    });

    it('should pass through messages without tool calls unchanged', () => {
        const msgs = [user('hi'), assistant('hello')];
        const result = ContextCompressor.collapseToolMessagesForSummary(msgs);
...
// ContextCompressor) because it has no dependence on compressor state and
...
describe('ContextCompressor.collapseToolMessagesForSummary (media interleave)', () => {
    it('collapses tool results that follow an interleaved user(media) message', () => {
        ...
        const out = ContextCompressor.collapseToolMessagesForSummary(msgs);
