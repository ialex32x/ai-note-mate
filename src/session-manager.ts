...
export class SessionManager {
    ...
    private async loadMessages(id: string): Promise<void> {
        ...
        try {
            ...
            if (await adapter.exists(msgPath)) {
                ...
                if ((data.version === 1 || data.version === 2 || data.version === 3 || data.version === 4 || data.version === 5 || data.version === 6 || data.version === 7) && data.id === id) {
    ...
    private async saveMessages(id: string): Promise<void> {
        ...
        try {
            ...
            const version: 1 | 2 | 3 | 4 | 5 | 6 | 7 = hasToolCallAssetsData
                ? 7
