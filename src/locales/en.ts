export const en: Record<string, string> = {
	...
	'settings.agentToolsPreview': 'MCP tools preview',
	'settings.agentToolsPreviewNone': 'No tool patterns defined. Add patterns above to see matching MCP tools here.',
	'settings.agentToolsPreviewNoMcp': 'No MCP servers with tools configured. Set up servers in Settings → Tools first.',
	'settings.agentToolsPreviewNoMatch': 'No MCP tools match the configured patterns.',
	'settings.agentToolsPreviewCount': '{count} MCP tools matched',
