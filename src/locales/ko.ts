export const ko: Record<string, string> = {
	...
	'settings.deleteAgentDesc': '이 에이전트를 목록에서 제거합니다. 노트 자체는 삭제되지 않습니다.',
	'settings.agentsEmpty': '사용자 지정 에이전트 없음',
	'settings.agentsEmptyDesc': '에이전트를 추가한 다음 노트를 지정하세요. 노트의 frontmatter `tools` 필드에 사용 가능한 도구 패턴을 나열하고, 본문이 에이전트의 프롬프트가 됩니다.',
	'settings.agentUntitled': '제목 없는 에이전트',
	'settings.agentNotePath': '에이전트 노트 경로',
	'settings.agentNotePathDesc': '이 에이전트를 정의하는 노트의 보관소 상대 경로입니다. 에이전트를 구성하려면 노트를 직접 편집하세요. 이 패널은 읽기 전용 미리 보기만 표시합니다.',
	'settings.agentNotePathPlaceholder': '예: Agents/My agent.md',
	'settings.agentNotePathEmptyError': '에이전트 노트 경로가 비어 있습니다.',
	'settings.agentOpenNote': '에이전트 노트를 새 탭에서 열기',
	'settings.agentNoteMissing': '에이전트 노트가 아직 존재하지 않습니다.',
	'settings.agentCreateDefault': '기본 템플릿에서 에이전트 노트 생성',
	'settings.agentCreated': '{path}에 에이전트 노트를 생성했습니다.',
	'settings.agentParsedConfig': '파싱된 구성',
	'settings.agentTools': '도구',
	'settings.agentToolsNone': '도구 패턴이 정의되지 않았습니다(frontmatter `tools`가 비어 있음).',
	'settings.agentPrompt': '프롬프트',
	'settings.agentPromptEmpty': '프롬프트 내용이 없습니다(노트 본문이 비어 있음).',
	'settings.agentPathEmpty': '이 에이전트의 구성을 불러오려면 위에 노트 경로를 설정하세요.',
	'settings.agentLoading': '에이전트 구성 불러오는 중…',
	'settings.agentReadFailed': '에이전트 노트 읽기 실패: {msg}',
