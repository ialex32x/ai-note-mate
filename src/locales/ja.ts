export const ja: Record<string, string> = {
	...
	'settings.agentToolsPreview': 'MCP ツールプレビュー',
	'settings.agentToolsPreviewNone': 'ツールパターンが定義されていません。上でパターンを追加すると、一致する MCP ツールがここに表示されます。',
	'settings.agentToolsPreviewNoMcp': 'MCP サーバーツールが設定されていません。先に 設定 → Tools でサーバーを設定してください。',
	'settings.agentToolsPreviewNoMatch': '設定されたパターンに一致する MCP ツールはありません。',
	'settings.agentToolsPreviewCount': '{count} 個の MCP ツールが一致しました',
