export const ja: Record<string, string> = {
	...
	'settings.deleteAgentDesc': 'このエージェントを一覧から削除します。ノート自体は削除されません。',
	'settings.agentsEmpty': 'カスタムエージェントがありません',
	'settings.agentsEmptyDesc': 'エージェントを追加してノートを指定してください。ノートのフロントマター `tools` フィールドに使用できるツールのパターンを記載し、本文がエージェントのプロンプトになります。',
	'settings.agentUntitled': '無題のエージェント',
	'settings.agentNotePath': 'エージェントノートのパス',
	'settings.agentNotePathDesc': 'このエージェントを定義するノートのVault相対パスです。設定はノートを直接編集してください。このパネルは読み取り専用のプレビューのみを表示します。',
	'settings.agentNotePathPlaceholder': '例: Agents/My agent.md',
	'settings.agentNotePathEmptyError': 'エージェントノートのパスが空です。',
	'settings.agentOpenNote': 'エージェントノートを新しいタブで開く',
	'settings.agentNoteMissing': 'エージェントノートはまだ存在しません。',
	'settings.agentCreateDefault': 'デフォルトテンプレートからエージェントノートを作成',
	'settings.agentCreated': '{path} にエージェントノートを作成しました。',
	'settings.agentParsedConfig': '解析された設定',
	'settings.agentTools': 'ツール',
	'settings.agentToolsNone': 'ツールパターンが定義されていません（フロントマター `tools` が空です）。',
	'settings.agentPrompt': 'プロンプト',
	'settings.agentPromptEmpty': 'プロンプトの内容がありません（ノート本文が空です）。',
	'settings.agentPathEmpty': '上でノートのパスを設定すると、このエージェントの設定が読み込まれます。',
	'settings.agentLoading': 'エージェント設定を読み込み中…',
	'settings.agentReadFailed': 'エージェントノートの読み込みに失敗しました: {msg}',
