export const ja: Record<string, string> = {
	...
	'view.explainPrompt': '以下のノートで選択された内容を説明してください:\n{snippet}',
	...
	'settings.artifactStoreDesc': '会話の圧縮時に失われがちな、サブエージェントが返した大きな値をキャッシュし、後からアシスタントが呼び戻せるようにします。セッション単位・メモリ内のみで、ディスクには書き込まれません。',
	'settings.artifactStoreTotalBytesKb': 'キャッシュ全体サイズ（KB）',
	'settings.artifactStoreTotalBytesKbDesc': '1 つのセッションでキャッシュする総バイト数の上限。超えると最も古くアクセスされた項目から順に破棄されます。デフォルト 1024（1 MB）。1 未満はデフォルトに戻ります。',
	'settings.artifactStoreSingleArtifactKb': '単一エントリのサイズ（KB）',
	'settings.artifactStoreSingleArtifactKbDesc': 'これより大きい値はキャッシュされず、エンベロープには too_large_for_store として記録されます。デフォルト 128。1 未満はデフォルトに戻ります。通常はキャッシュ全体サイズ以下にしてください。',
	'settings.artifactStoreTtlMinutes': 'エントリ TTL（分）',
	'settings.artifactStoreTtlMinutesDesc': '最終アクセスからこの分数を超えたキャッシュを破棄します。0 にすると TTL を無効化し、LRU またはセッション終了でしか退去しません。デフォルト 30。',
