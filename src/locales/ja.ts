...
`,
	...
	'tips.configureProfile.title': 'AI プロファイルを設定する',
	'tips.configureProfile.body': 'チャットを始める前に、アクティブなプロファイルで Base URL、モデル、API キーを入力してください。API キーは Obsidian Keychain に保存され、プラグイン設定に平文で記録されません。安心してご利用ください。「試してみる」でプロファイルセクションに直接移動できます。',
	'tips.configureProfile.openFailed': '設定パネルを自動で開けませんでした。手動で 設定 → Note Mate → プロファイル を開いてください。',
