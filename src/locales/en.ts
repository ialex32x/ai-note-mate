...
`,
	...
	'tips.configureProfile.title': 'Set up your AI profile',
	'tips.configureProfile.body': 'Before chatting, fill in Base URL, model, and API key on your active Profile. The API key is stored via Obsidian Keychain — it is not saved in plain text in the plugin settings, so you can use it with confidence. Click Try it to jump straight to the Profile section.',
	'tips.configureProfile.openFailed': 'Could not open the settings panel. Open Settings → Note Mate → Profile manually.',
