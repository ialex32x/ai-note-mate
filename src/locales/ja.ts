export const ja: Record<string, string> = {
	...
	'settings.skillFilterSimilarityThreshold': 'スキルフィルター:類似度しきい値',
	...
	'settings.skillTesterDesc': '仮想のユーザー質問を入力して、どのスキルがマッチするか確認できます。設定画面を離れずに description / when_to_use / triggers を調整するのに便利です。',
	'settings.skillTesterPlaceholder': '例:「プロジェクトノートのタグを整理して」',
	'settings.skillTesterRun': 'テスト',
	'settings.skillTesterRunning': '埋め込み中…',
	'settings.skillTesterNotReady': '先に埋め込みプロバイダを設定して有効化してください。',
	'settings.skillTesterNoApiKey': 'アクティブな埋め込み設定に API キーがありません。',
	'settings.skillTesterFailed': '埋め込みに失敗しました — 詳細は開発者コンソールを確認してください。',
	...
	'settings.skillTesterBandBelow': '除外',
	...
	'settings.memoryRelevantTopKDesc': '毎ターン embedding 類似度で選ばれる非クリティカルエントリの上限。0 で関連プールを無効化します。',
	'settings.memoryRelevantMinSimilarity': '関連記憶: 類似度しきい値',
	'settings.memoryRelevantMinSimilarityDesc': '非クリティカルエントリが embedding フィルター後に残るために必要な最小コサイン類似度（0–1）。使用する embedding モデルの分布に合わせて調整してください。',
