export const ko: Record<string, string> = {
	...
	'settings.memoryRelevantTopKDesc': '매 턴 임베딩 유사도로 선택되는 비중요 항목 수 상한. 0이면 관련 기억 경로가 비활성화됩니다.',
	'settings.memoryRelevantMinSimilarity': '관련 기억: 유사도 임계값',
	'settings.memoryRelevantMinSimilarityDesc': '비중요 항목이 임베딩 필터링 후 유지되기 위한 최소 코사인 유사도(0–1). 사용 중인 임베딩 모델의 분포에 맞춰 조정하세요.',
