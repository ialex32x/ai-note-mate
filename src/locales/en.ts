export const en: Record<string, string> = {
	...
	'settings.memoryConsolidateThreshold': 'Consolidation threshold',
	'settings.memoryConsolidateThresholdDesc': 'When the non-critical memory pool exceeds this many entries, a one-time LLM pass merges related entries and deletes obsolete ones to keep the pool lean. Set to 0 to disable consolidation',
	'settings.memoryConsolidateCooldownHours': 'Consolidation cooldown (hours)',
	'settings.memoryConsolidateCooldownHoursDesc': 'Minimum hours between two consolidation passes. Prevents burning tokens on back-to-back runs during heavy chat sessions',
	'settings.memoryConsolidation': 'Consolidation',
