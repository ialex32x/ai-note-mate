export const zhTW: Record<string, string> = {
	...
	'settings.skillFilterSimilarityThreshold': '技能過濾:相似度閾值',
	...
	'settings.skillTesterDesc': '輸入一段假設的使用者提問,看看哪些技能會命中。便於在不離開設定的情況下調整 description / when_to_use / triggers。',
	'settings.skillTesterPlaceholder': '例如:"幫我把專案筆記的標籤整理一下"',
	'settings.skillTesterRun': '測試',
	'settings.skillTesterRunning': '正在嵌入…',
	'settings.skillTesterNotReady': '請先設定並啟用嵌入服務。',
	'settings.skillTesterNoApiKey': '目前嵌入設定沒有 API 金鑰。',
	'settings.skillTesterFailed': '嵌入失敗 — 詳情請查看開發者主控台。',
	...
	'settings.skillTesterBandBelow': '已過濾',
	...
	'settings.memoryRelevantTopKDesc': '每輪依 embedding 相似度選中的非關鍵記憶條目數上限。設為 0 時停用相關記憶通道。',
	'settings.memoryRelevantMinSimilarity': '相關記憶: 相似度門檻',
	'settings.memoryRelevantMinSimilarityDesc': '非關鍵條目在 embedding 過濾後被保留所需的最低餘弦相似度（0–1）。請依照你使用的 embedding 模型分布調整。',
